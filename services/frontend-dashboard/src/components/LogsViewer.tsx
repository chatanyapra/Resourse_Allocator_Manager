            ...
            {status.pods.map((pod) => {
              ...
              return (
                <button
                  ...
                  className={`text-left bg-surface-container-high rounded-lg p-3 border border-outline-variant/10 hover:border-outline-variant/20 transition-all duration-200 cursor-pointer ${
              ...
              >
                ...
                <span
                  className={`flex-1 break-all ${
                    LOG_LEVEL_COLORS[entry.level] || "text-slate-300"
                  }`}
                >
                  {entry.message}
                </span>
